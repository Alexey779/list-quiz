...
export const User = ({id, email, first_name, last_name, avatar, onClickInvate, inVated}) => (
  <li>
    <div>
    ...
    <img onClick={() => onClickInvate(id)} className="action" src={`/assets/${inVated ? 'minus' : 'plus'}.svg`} alt="Action" />
  </li>
);
